"""
Django settings for the FoodHub API.

All secrets and environment-specific values come from environment
variables (12-factor). Nothing sensitive is committed to the repo.
"""
...
# SQLite by default for zero-setup local dev; Postgres in docker/prod
# via DATABASE_URL (e.g. postgres://user:pass@host:5432/foodhub).
DATABASES = {
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 20,
    "EXCEPTION_HANDLER": "foodhub.exceptions.exception_handler",
}
...
# Overpass API endpoint for restaurant sync (free, keyless OSM service).
